    ...
    public function index(): void {
        ...
        if (($this->request->server['REQUEST_METHOD'] ?? '') === 'POST' && $this->validate()) {
            ...
            if ($module_id) {
                ...
                $this->model_setting_module->addModule('opencart_filter.attribute_filter', $data);
            }
        ...
        foreach ([
            ...
            'button_cancel', 'button_rebuild', 'help_attribute', 'help_auto_index', 'help_limit'
        ] as $key) {
        ...
        $data['breadcrumbs'] = [
            ...
            [
                ...
                'href' => $this->url->link('extension/opencart_filter/module/attribute_filter', 'user_token=' . $this->session->data['user_token'])
            ]
        ];
        ...
        $data['action'] = $this->url->link('extension/opencart_filter/module/attribute_filter', 'user_token=' . $this->session->data['user_token'] . ($module_id ? '&module_id=' . $module_id : ''));
