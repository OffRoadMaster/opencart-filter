<?php
namespace Opencart\Catalog\Controller\Extension\OpencartFilter\Module;
...
class AttributeFilter extends \Opencart\System\Engine\Controller {
    public function index(array $setting): string {
        ...
        $groups = $this->model_extension_opencart_filter_module_attribute_filter->getFilterGroups($category_id, (int)$this->config->get('config_language_id'), $attribute_ids);
        ...
        $data = [
            ...
            'groups' => $groups,
            'ajax_url' => $this->url->link('extension/opencart_filter/module/attribute_filter.ajax'),
            'category_id' => $category_id,
            'limit' => max(1, (int)($setting['limit'] ?? 24))
        ];

        return $this->load->view('extension/opencart_filter/module/attribute_filter', $data);
    }
    ...
    public function ajax(): void {
        ...
        $product_ids = $category_id ? $this->model_extension_opencart_filter_module_attribute_filter->getProductIds($category_id, (int)$this->config->get('config_language_id'), $filters) : [];
        $products = [];
