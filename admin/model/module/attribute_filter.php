<?php
namespace Opencart\Admin\Model\Extension\AJAXaf\Module;

class AttributeFilter extends \Opencart\System\Engine\Model {
    private const EVENT_CODE = 'AJAXaf_attribute_filter_reindex';
    ...
    public function registerEvents(): void {
        ...
        foreach ($events as $trigger) {
            $this->model_setting_event->addEvent([
                ...
                'trigger' => $trigger,
                'action' => 'extension/AJAXaf/module/attribute_filter.reindexEvent',
                'status' => true,
                'sort_order' => 0
            ]);
        }
